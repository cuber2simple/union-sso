...
comment on column t_login_log.login_result 		    is '登陆结果 success/fail/abnormal/reject  成功/失败/异常/风控拦截';
...
comment on column t_operate_log.operate_result 		is '操作日志,success/fail/abnormal  成功/失败/异常';
