...
public class KaptchaController {
    ...
    @ResponseBody
    public Resp verifyCaptcha(@RequestParam(VERIFY_CODE) String verifyCode, HttpSession session) {
        boolean verifyResult = verifyCode.equals(session.getAttribute(VERIFY_CODE));
        Resp resp = RpcUtils.fail(verifyCode);
        if (verifyResult) {
